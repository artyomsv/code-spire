...
const REASONS: Record<string, string> = {
  ...
  sign_in_not_started: 'No run worker showed a code within five minutes. Check that the run worker is running and can start the agent image, then start again.',
};
