...
import { eventsCard, findingsCard, generalDiscussionCard, metaCard, openInLabel, outcomeBadge, reconciliationCard, safeHttpUrl, stageLabel, STATUS_LABEL, stepper, usageCard } from '../render';
  ...
  return (
    <section className="content" id="view-detail">
      ...
      <div className="grid2" style={{ marginTop: 18 }}>
        <div>
          {reconciliationCard(r.reconciliation ?? [])}
          {findingsCard(r)}
