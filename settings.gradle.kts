...
include("spire-harness-codex")
include("spire-secrets")
include("spire-workspace")
include("spire-worksource")
include("spire-worksource-github")
include("spire-worksource-jira")
include("spire-worksource-gitlab")
include("spire-runtime")
include("spire-runtime-docker")
include("spire-publisher")
include("spire-run-worker")
