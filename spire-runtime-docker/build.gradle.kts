...
dependencies {
    ...
    // Declared rather than inherited through docker-java: copyArchiveFromContainer answers with a
    // TAR stream, and reading it off a transitive runtime dependency is how a library upgrade becomes
    // an unrelated compile break.
